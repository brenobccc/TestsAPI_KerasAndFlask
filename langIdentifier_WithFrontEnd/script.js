...
function fetchMl(){
	...
	fetch(url)//mando por parametro minha url da API
	   ...
	   .then(n => {//visualização no console 
		...
		document.getElementById('English').innerHTML = n.English;
		document.getElementById('Espanol').innerHTML = n.Espanol;
		document.getElementById('Francais').innerHTML = n.Francais;
	   }) 
}
